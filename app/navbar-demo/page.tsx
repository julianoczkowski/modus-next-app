    ...
    >
      ...
      >
        <ModusNavbar
          ...
          startContent={<div className="text-base font-semibold text-foreground">Trimble Atlas</div>}
          centerContent={
          ...
          endContent={<div className="text-sm text-foreground opacity-80">Help</div>}
        />
      </DemoExample>
    </DemoPage>
  );
