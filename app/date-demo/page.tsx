    ...
    >
      ...
      >
        <div className="flex flex-col gap-4 md:flex-row">
          <ModusDate label="Start" value="2025-04-01" min="2025-04-01" max="2025-06-30" size="sm" />
          <ModusDate label="End" value="2025-04-15" min="2025-04-01" max="2025-06-30" size="sm" />
        </div>
      </DemoExample>
    </DemoPage>
  );
