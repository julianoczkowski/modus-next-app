...
export default function CardDemoPage() {
  return (
    ...
    >
      ...
      >
        <ModusCard
          title={<div className="text-xl font-semibold text-foreground">Atlas Renewal</div>}
          subtitle={<div className="text-sm text-foreground opacity-80">Updated 2 hours ago</div>}
          actions={
      ...
      >
        <ModusCard
          ...
          padding="compact"
          bordered
          title={<div className="text-lg font-medium text-foreground">Field kit</div>}
          subtitle={<div className="text-sm text-foreground opacity-80">Inventory: 18 units available</div>}
          actions={<ModusButton size="sm">Reserve</ModusButton>}
        >
          <div className="text-sm text-foreground opacity-80">
            Includes GPS, survey equipment, and safety checklist. Recommended for
            teams working on remote installs.
          </div>
        </ModusCard>
      </DemoExample>
    </DemoPage>
