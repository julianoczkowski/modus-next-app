...
/**
 * Modus Icons Linting Script for Next.js
 *
 * This script checks for usage of non-Modus icon patterns in React/Next.js files
...
async function main() {
  console.log("🎨 Checking for Modus Icons usage in Next.js app...\n");
